            ...
            <div class="demo-inner-content">
                <div class="container">
                    <div class="banner-info">
                        ...
                        <a class="btn btn-style btn-style-2 mt-sm-5 mt-4" href="appointment">Book Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container py-md-5 py-4">
        <div class="row pb-xl-5 align-items-center">
            ...
            <div class="col-xl-5 col-lg-6 offset-xl-1 mt-lg-0 mt-5 pt-lg-0 pt-5">
                ...
                <p class="sub-para">"Our clients are our priority, we offer quality dental services with a team of specialists. More details about our services below".</p>
                <p class="mt-4 pt-sm-2">Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula. Semper at tempufddfel. Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
                <p class="mt-4 pt-sm-2">Sellen tesque libero ut justo, ultrices in ligula. Semper at tempufddfel. Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
            </div>
        </div>
    </div>
...
<section class="about-section text-center pt-lg-5 pb-5">
    <div class="container pt-lg-5 pb-lg-5 pb-4">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="about-single p-3">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about">General Dentistry</a></h5>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit accusa ntium dolor emque laudan.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-md-0 mt-3">
                <div class="about-single p-3">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about">Urgent Surgery</a></h5>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit accusa ntium dolor emque laudan.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mt-lg-0 mt-3">
                <div class="about-single p-3">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about">Dental Implants</a></h5>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit accusa ntium dolor emque laudan.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mt-4">
                <div class="about-single p-3">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about">Tooth Whitening</a></h5>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit accusa ntium dolor emque laudan.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mt-4">
                <div class="about-single p-3">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about">Prosthesis</a></h5>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit accusa ntium dolor emque laudan.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mt-4">
                <div class="about-single p-3">
                    ...
                    <div class="about-content">
                        <h5 class="mb-3"><a href="about">Dental Braces</a></h5>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit accusa ntium dolor emque laudan.
                        </p>
                    </div>
                </div>
        ...
        <a href="services" class="btn btn-style mt-5">Learn More</a>
    </div>
</section>
<!-- //home block 2 -->
            ...
            <div class="owl-three owl-carousel owl-theme">
                <div class="item">
                    <div class="content-left-sec">
                        <a class="blog-link d-block zoom-image" href="#url"><img src="assets/images/s1.jpg" class="img-fluid scale-image" alt=""></a>
                        <div class="blog-info">
                            <a href="#url">
                                <h4 class="mb-0">Sedation Dentistry</h4>
                            </a>
                            <p>Donec luctus rhoncus dignissim. Integer blandit mattis arcu, id orci.</p>
                            <a href="services" class="btn btn-style-primary">Learn More<i
                ...
                <div class="item">
                    <div class="content-left-sec">
                        <a class="blog-link d-block zoom-image" href="#url"><img src="assets/images/s2.jpg" class="img-fluid scale-image" alt=""></a>
                        <div class="blog-info">
                            <a href="#url">
                ...
                <div class="item">
                    <div class="content-left-sec">
                        <a class="blog-link d-block zoom-image" href="#url"><img src="assets/images/s3.jpg" class="img-fluid scale-image" alt=""></a>
                        <div class="blog-info">
                            <a href="#url">
                ...
                <div class="item">
                    <div class="content-left-sec">
                        <a class="blog-link d-block zoom-image" href="#url"><img src="assets/images/s4.jpg" class="img-fluid scale-image" alt=""></a>
                        <div class="blog-info">
                            <a href="#url">
                ...
                <div class="item">
                    <div class="content-left-sec">
                        <a class="blog-link d-block zoom-image" href="#url"><img src="assets/images/s5.jpg" class="img-fluid scale-image" alt=""></a>
                        <div class="blog-info">
                            <a href="#url">
                ...
                <div class="item">
                    <div class="content-left-sec">
                        <a class="blog-link d-block zoom-image" href="#url"><img src="assets/images/s7.jpg" class="img-fluid scale-image" alt=""></a>
                        <div class="blog-info">
                            <a href="#url">
    ...
    <div class="container py-md-5 py-4">
        <div class="row py-4">
            <div class="col-md-7 pe-lg-5">
                ...
                <p class="mb-3">Nibh eu consequat magna ipsum ac ex. Nulla iaculis tincidunt elit, tortor luctus sit amet.
                </p>
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                <a href="about" class="btn btn-style btn-style-2 mt-lg-5 mt-4">Learn More</a>
            </div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            ...
            <div class="right-content-call mt-sm-0 mt-4">
                <ul class="buttons">
                    ...
                    <li><a href="appointment" class="btn btn-style btn-style-2 mt-lg-0 mt-3">Book Now</a> </li>
                </ul>
            </div>
        </div>
    </div>
