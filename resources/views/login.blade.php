...
<section class="inner-banner py-5">
    <div class="w3l-breadcrumb py-lg-5">
        <div class="container pt-4 pb-sm-4">
            <h4 class="inner-text-title font-weight-bold pt-sm-5 pt-4">Login</h4>
...
<section class="w3l-contact-11 py-5" id="contact">
    <div class="container py-md-5 py-4">
        <h3 class="title-style text-center mb-5"><span>Login</h3>
        ...
        <div class="form-inner-cont mx-auto" style="max-width:800px">
            <form action="" method="post" class="signin-form">
                @csrf
                <div class=" text-center align-form-map">
                ...
                <div class="submit text-right">
                    <button type="submit" class="btn btn-style">login
                        </button>
